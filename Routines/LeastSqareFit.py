...
# This could be a function in the Header in Astrometry.py -> So ImageAnalyzer can call it as a function and returns those parameters
# Make this as a routine cio' come import e funzione in ImageAnalyzer.py
...
###### Change the loop with x11=np.sum(u_Image*u_Image*u_Image*u_Image) -> No more loop
###        and x21=x12
##      define u2_Image=u_Image*u_Image
        ...
        #Comparison with Leastsquare Function -> This is faster
